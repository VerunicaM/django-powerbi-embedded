...
$(function () {
    ...
    var workspace_id = url.searchParams.get("workspace_id");
    var report_id = url.searchParams.get("report_id");
    ...
    $.ajax({
        type: "GET",
        url: "/embed-info/?" + "workspace_id=" +workspace_id + "&report_id=" + report_id,
        dataType: "json",
        success: function (data) {
            ...
            reportLoadConfig.embedUrl = embedData.reportConfig.embedUrl;
